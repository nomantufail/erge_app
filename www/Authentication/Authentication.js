...
.controller('loginCtrl', function($scope, $sce, Utils, $ionicPopover, $state, $ionicLoading, ServerRequest, API, $localstorage, $ionicHistory, MyHttpRequest) {
        ...
        $scope.highlight_boss = 'blue-btn';
        $scope.highlight_con = 'darkblue-btn';
        /*Ligin data modal*/
        ...
        $scope.highlightRoleButton = function(role) {
            if (role == 'boss') {
                $scope.highlight_boss = 'blue-btn';
                $scope.highlight_con = 'darkblue-btn';
            } else {
                $scope.highlight_con = 'blue-btn';
                $scope.highlight_boss = 'darkblue-btn';
            }
        }
